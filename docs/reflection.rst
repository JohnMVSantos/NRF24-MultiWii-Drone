...
I have also updated the power lines to be 0.45-0.50mm thick in comparison to traditional lines only at 0.254mm thick. This reduces resistance added on the power lines for more direct current flow. There are also no 90 degree traces in the PCB design which can cause impedance issues. 
...
1. Battery should be 25C and higher
...
.. image:: assets/mosfet-diagram.png
   :width: 300px
   :align: center
   :alt: Mosfet Testing

.. image:: assets/20260429_225320.jpg
   :width: 300px
   :align: center
   :alt: Mosfet Testing Probes

3. Test Motor terminals if voltage is received

.. image:: assets/motor-voltage-input.png
   :width: 300px
   :align: center
   :alt: Motor Terminal Voltage
